    ...
    return (
        <FormField
            ...
            render={({ field }) => {
                ...
                const controlledValue = field.value !== undefined ? field.value :
                    (innerSchema instanceof z.ZodBoolean ? false :
                        innerSchema instanceof z.ZodNumber ? 0 :
...
export function FormGenerator<T extends z.ZodType<any, any>>({
    ...
    const schemaDefaults = schema instanceof z.ZodObject ?
