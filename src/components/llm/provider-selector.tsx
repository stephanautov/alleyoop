...
import { LLMService, type ProviderName, type ModelInfo } from '~/server/services/llm';
...
const providerInfo: Record<ProviderName, {
    name: string;
    description: string;
...
export function ProviderSelector({
    ...
    return (
        <div className="space-y-4">
            <Tabs value={selectedProvider} onValueChange={(v) => handleProviderChange(v as ProviderName)}>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="grid grid-cols-2 gap-4 text-sm">
                                                    <div>
                                                        ...
                                                        <span className="ml-2">${selectedModelInfo.costPer1kTokens.input}/1k tokens</span>
                                                    </div>
                                                    <div>
                                                        <span className="text-muted-foreground">Output:</span>
                                                        <span className="ml-2">${selectedModelInfo.costPer1kTokens.output}/1k tokens</span>
                                                    </div>
                                                </div>
                                                ...
                                                {documentType && (
                                                    <Alert>
                                                        ...
                                                        <AlertDescription>
                                                            Estimated cost for this document: <strong>${estimatedCost.toFixed(3)}</strong>
                                                        </AlertDescription>
                                                    </Alert>
                                                )}
                                            </div>
