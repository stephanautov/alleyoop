...
export default function NewDocumentPage() {
    ...
    const { data: availableTypes, isLoading } = api.document.getAvailableTypes.useQuery();
                        ...
                        <Card>
                            <CardHeader>
                                <div className="flex items-center justify-between">
                                    <div>
                                        <CardTitle>{getDocumentConfig(selectedType).name}</CardTitle>
                                        <CardDescription>
                            ...
                            <CardContent>
                                <Tabs defaultValue="medium" className="w-full">
                                    ...
                                    {["short", "medium", "long"].map((length) => {
                                        ...
                                        return (
                                            <TabsContent key={length} value={length} className="space-y-2">
    ...
    const typeSpecificConfig: Record<DocumentType, any> = {
        [DocumentType.BIOGRAPHY]: {
            ...
            additionalInfo: {
                ...
                placeholder: "Any specific details, achievements, or context you want included",
                type: "textarea",
                rows: 4,
            },
        },
