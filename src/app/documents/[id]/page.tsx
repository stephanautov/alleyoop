    ...
    <div className="container mx-auto space-y-6 py-6">
      ...
      {isProcessing ? (
        ...
        <Alert variant="destructive">
          ...
          <AlertDescription>
            Document generation failed. Please try again or contact support if
            the issue persists.
          </AlertDescription>
        </Alert>
                      ...
                      (document.sections as any[])
                        ...
                        .map((section) => (
                          <div key={section.id} className="space-y-2">
                            ...
                            {section.order <
                              (document.sections as any[]).length && (
                      ...
                      <pre className="text-muted-foreground text-sm whitespace-pre-wrap">
                        {document.outline
                          ? typeof document.outline === "string"
                            ? document.outline
                            : (document.outline as any).content ||
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {(
                      (document.promptTokens ?? 0) +
                      (document.completionTokens ?? 0)
                    ).toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  ...
                  {document.exports.map((exp: any) => (
                    ...
                    >
                      ...
                      <span className="text-muted-foreground">
                        {formatDistanceToNow(exp.createdAt, {
                          addSuffix: true,
                        })}
                      </span>
                    </div>
            ...
            {document.status === DocumentStatus.COMPLETED && (
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  >
                    <Link
                      href={`/documents/new?type=${document.type}&clone=${document.id}`}
                    >
                  ...
                  >
                    <Link
                      href={`/api/export/${document.id}?format=pdf&preview=true`}
                      target="_blank"
                    >
