...
const progressStages = [
  {
    value: 5,
    label: "Initializing",
    description: "Setting up document generation",
  },
  {
    value: 20,
  ...
  },
  {
    ...
    description: "Creating document structure",
  },
  {
    value: 70,
...
export function DocumentProgress({ documentId }: DocumentProgressProps) {
  ...
  ) ?? progressStages[0]) as (typeof progressStages)[number];
        ...
        {status === "failed" ? (
          ...
          <>
            ...
            <Alert>
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                Document generation typically takes 3-5 minutes depending on
                length and complexity. You can leave this page and come back
                later - we'll notify you when it's ready.
              </AlertDescription>
            </Alert>
          </>
        )}
