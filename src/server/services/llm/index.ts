...
export class LLMService {
    ...
    constructor(config: LLMServiceConfig = {}) {
        this.providerName = config.provider || (env.DEFAULT_LLM_PROVIDER as ProviderName) || 'openai';
    ...
    private getSystemPrompt(type: DocumentType): string {
        const prompts: Record<DocumentType, string> = {
            [DocumentType.BIOGRAPHY]: 'You are an expert biographer who creates compelling, accurate, and well-researched biographical content.',
            [DocumentType.CASE_SUMMARY]: 'You are a legal expert specializing in creating clear, accurate case summaries with proper legal citations.',
            [DocumentType.BUSINESS_PLAN]: 'You are a business consultant expert at creating comprehensive, investor-ready business plans.',
            [DocumentType.MEDICAL_REPORT]: 'You are a medical documentation specialist who creates clear, accurate medical reports.',
            [DocumentType.GRANT_PROPOSAL]: 'You are a grant writing expert who creates compelling, well-structured grant proposals.',
        };
